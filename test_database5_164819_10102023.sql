...
-- Started on 2023-10-10 16:48:19 CEST
...
--
-- TOC entry 8 (class 2615 OID 36205)
-- Name: test3; Type: SCHEMA; Schema: -; Owner: atlas
--

CREATE SCHEMA test3;


ALTER SCHEMA test3 OWNER TO atlas;
...
--
-- TOC entry 239 (class 1259 OID 36208)
-- Name: color; Type: TABLE; Schema: test3; Owner: atlas
--

CREATE TABLE test3.color (
    id bigint NOT NULL,
    name character varying(255)
);


ALTER TABLE test3.color OWNER TO atlas;

--
-- TOC entry 238 (class 1259 OID 36207)
-- Name: color_id_seq; Type: SEQUENCE; Schema: test3; Owner: atlas
--

CREATE SEQUENCE test3.color_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE test3.color_id_seq OWNER TO atlas;

--
-- TOC entry 3523 (class 0 OID 0)
-- Dependencies: 238
-- Name: color_id_seq; Type: SEQUENCE OWNED BY; Schema: test3; Owner: atlas
--

ALTER SEQUENCE test3.color_id_seq OWNED BY test3.color.id;


--
-- TOC entry 240 (class 1259 OID 36214)
-- Name: color_item; Type: TABLE; Schema: test3; Owner: atlas
--

CREATE TABLE test3.color_item (
    color_id bigint NOT NULL,
...
ALTER TABLE test3.color_item OWNER TO atlas;

--
-- TOC entry 241 (class 1259 OID 36219)
-- Name: image; Type: TABLE; Schema: test3; Owner: atlas
--

CREATE TABLE test3.image (
    id bigint NOT NULL,
    file character varying(255),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE test3.image OWNER TO atlas;

--
-- TOC entry 243 (class 1259 OID 36225)
-- Name: imagerequest; Type: TABLE; Schema: test3; Owner: atlas
--

CREATE TABLE test3.imagerequest (
    id bigint NOT NULL,
    file character varying(255),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE test3.imagerequest OWNER TO atlas;

--
-- TOC entry 242 (class 1259 OID 36224)
-- Name: imagerequest_id_seq; Type: SEQUENCE; Schema: test3; Owner: atlas
--

CREATE SEQUENCE test3.imagerequest_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE test3.imagerequest_id_seq OWNER TO atlas;

--
-- TOC entry 3524 (class 0 OID 0)
-- Dependencies: 242
-- Name: imagerequest_id_seq; Type: SEQUENCE OWNED BY; Schema: test3; Owner: atlas
--

ALTER SEQUENCE test3.imagerequest_id_seq OWNED BY test3.imagerequest.id;


--
-- TOC entry 244 (class 1259 OID 36231)
-- Name: item; Type: TABLE; Schema: test3; Owner: atlas
--

CREATE TABLE test3.item (
    id bigint NOT NULL,
    author character varying(250),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE test3.item OWNER TO atlas;

--
-- TOC entry 237 (class 1259 OID 36206)
-- Name: native; Type: SEQUENCE; Schema: test3; Owner: atlas
--

CREATE SEQUENCE test3.native
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE test3.native OWNER TO atlas;

--
-- TOC entry 245 (class 1259 OID 36238)
-- Name: request; Type: TABLE; Schema: test3; Owner: atlas
--

CREATE TABLE test3.request (
    id bigint NOT NULL,
    createdate timestamp without time zone,
    link bigint,
    local_visibility boolean NOT NULL,
...
ALTER TABLE test3.request OWNER TO atlas;

--
-- TOC entry 3285 (class 2604 OID 36049)
...
--
-- TOC entry 3286 (class 2604 OID 36066)
...
--
-- TOC entry 3287 (class 2604 OID 36211)
-- Name: color id; Type: DEFAULT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.color ALTER COLUMN id SET DEFAULT nextval('test3.color_id_seq'::regclass);


--
-- TOC entry 3288 (class 2604 OID 36228)
-- Name: imagerequest id; Type: DEFAULT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.imagerequest ALTER COLUMN id SET DEFAULT nextval('test3.imagerequest_id_seq'::regclass);


--
-- TOC entry 3495 (class 0 OID 36046)
-- Dependencies: 230
...
--
-- TOC entry 3496 (class 0 OID 36057)
-- Dependencies: 231
...
--
-- TOC entry 3498 (class 0 OID 36063)
-- Dependencies: 233
...
--
-- TOC entry 3499 (class 0 OID 36069)
-- Dependencies: 234
...
--
-- TOC entry 3500 (class 0 OID 36076)
-- Dependencies: 235
...
--
-- TOC entry 3501 (class 0 OID 36081)
-- Dependencies: 236
...
--
-- TOC entry 3483 (class 0 OID 31116)
-- Dependencies: 218
...
--
-- TOC entry 3484 (class 0 OID 31122)
-- Dependencies: 219
...
--
-- TOC entry 3486 (class 0 OID 31130)
-- Dependencies: 221
...
--
-- TOC entry 3488 (class 0 OID 31139)
-- Dependencies: 223
...
--
-- TOC entry 3490 (class 0 OID 31146)
-- Dependencies: 225
...
--
-- TOC entry 3492 (class 0 OID 31153)
-- Dependencies: 227
...
10	t	test3	2023-09-25 08:57:41.428	2023-10-10 15:06:52.255	\N	admin	$2a$10$X3iBZZQgGfvxx4olu6YwCebHTBiV9iqcEAN3Anb4VbljJZV3oGhPa	\N	\N	2023-10-10 16:22:33.991
...
--
-- TOC entry 3504 (class 0 OID 36208)
-- Dependencies: 239
-- Data for Name: color; Type: TABLE DATA; Schema: test3; Owner: atlas
--

COPY test3.color (id, name) FROM stdin;
1	black
2	white
3	purple
4	green
...
--
-- TOC entry 3505 (class 0 OID 36214)
-- Dependencies: 240
-- Data for Name: color_item; Type: TABLE DATA; Schema: test3; Owner: atlas
--

COPY test3.color_item (color_id, itemlist_id, item_id) FROM stdin;
\.


--
-- TOC entry 3506 (class 0 OID 36219)
-- Dependencies: 241
-- Data for Name: image; Type: TABLE DATA; Schema: test3; Owner: atlas
--

COPY test3.image (id, file, createdate, modifydate, item_id) FROM stdin;
\.


--
-- TOC entry 3508 (class 0 OID 36225)
-- Dependencies: 243
-- Data for Name: imagerequest; Type: TABLE DATA; Schema: test3; Owner: atlas
--

COPY test3.imagerequest (id, file, createdate, modifydate, request_id) FROM stdin;
\.


--
-- TOC entry 3509 (class 0 OID 36231)
-- Dependencies: 244
-- Data for Name: item; Type: TABLE DATA; Schema: test3; Owner: atlas
--

COPY test3.item (id, author, createdate, modifydate, name, name2, text, typ, parent_group_id) FROM stdin;
1	\N	2023-10-10 16:22:34.287	2023-10-10 16:22:34.287	test3	\N	\N	0	\N
2	\N	2023-10-10 16:23:36.792	2023-10-10 16:23:36.792	weefewfwe	\N		1	1
5	\N	2023-10-10 16:35:35.482	2023-10-10 16:35:35.482	jhhjv	\N		1	1
\.


--
-- TOC entry 3510 (class 0 OID 36238)
-- Dependencies: 245
-- Data for Name: request; Type: TABLE DATA; Schema: test3; Owner: atlas
--

COPY test3.request (id, createdate, link, local_visibility, modifydate, name, parent_request_mark, request_mark, request_message, request_status, request_typ) FROM stdin;
\.
...
SELECT pg_catalog.setval('config.database_id_seq', 70, true);
...
SELECT pg_catalog.setval('config.log_id_seq', 43, true);
...
-- Dependencies: 238
-- Name: color_id_seq; Type: SEQUENCE SET; Schema: test3; Owner: atlas
--

SELECT pg_catalog.setval('test3.color_id_seq', 12, true);


--
-- TOC entry 3534 (class 0 OID 0)
-- Dependencies: 242
-- Name: imagerequest_id_seq; Type: SEQUENCE SET; Schema: test3; Owner: atlas
--

SELECT pg_catalog.setval('test3.imagerequest_id_seq', 1, false);


--
-- TOC entry 3535 (class 0 OID 0)
-- Dependencies: 237
-- Name: native; Type: SEQUENCE SET; Schema: test3; Owner: atlas
--

SELECT pg_catalog.setval('test3.native', 7, true);


--
-- TOC entry 3302 (class 2606 OID 36051)
...
--
-- TOC entry 3304 (class 2606 OID 36061)
...
--
-- TOC entry 3306 (class 2606 OID 36068)
...
--
-- TOC entry 3310 (class 2606 OID 36080)
...
--
-- TOC entry 3308 (class 2606 OID 36075)
...
--
-- TOC entry 3312 (class 2606 OID 36087)
...
--
-- TOC entry 3316 (class 2606 OID 36218)
-- Name: color_item color_item_pkey; Type: CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.color_item
    ADD CONSTRAINT color_item_pkey PRIMARY KEY (item_id, color_id);


--
-- TOC entry 3314 (class 2606 OID 36213)
-- Name: color color_pkey; Type: CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.color
    ADD CONSTRAINT color_pkey PRIMARY KEY (id);


--
-- TOC entry 3318 (class 2606 OID 36223)
-- Name: image image_pkey; Type: CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.image
    ADD CONSTRAINT image_pkey PRIMARY KEY (id);


--
-- TOC entry 3320 (class 2606 OID 36230)
-- Name: imagerequest imagerequest_pkey; Type: CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.imagerequest
    ADD CONSTRAINT imagerequest_pkey PRIMARY KEY (id);


--
-- TOC entry 3322 (class 2606 OID 36237)
-- Name: item item_pkey; Type: CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.item
    ADD CONSTRAINT item_pkey PRIMARY KEY (id);


--
-- TOC entry 3324 (class 2606 OID 36244)
-- Name: request request_pkey; Type: CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.request
    ADD CONSTRAINT request_pkey PRIMARY KEY (id);


--
-- TOC entry 3331 (class 2606 OID 36108)
...
--
-- TOC entry 3332 (class 2606 OID 36118)
...
--
-- TOC entry 3333 (class 2606 OID 36113)
...
--
-- TOC entry 3329 (class 2606 OID 36098)
...
--
-- TOC entry 3330 (class 2606 OID 36103)
...
--
-- TOC entry 3334 (class 2606 OID 36245)
-- Name: color_item fk1fdfy94almvf8nypjhfcwoc48; Type: FK CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.color_item
    ADD CONSTRAINT fk1fdfy94almvf8nypjhfcwoc48 FOREIGN KEY (itemlist_id) REFERENCES test3.item(id);


--
-- TOC entry 3339 (class 2606 OID 36270)
-- Name: item fk59u490xlr5kh712mrlav698pf; Type: FK CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.item
    ADD CONSTRAINT fk59u490xlr5kh712mrlav698pf FOREIGN KEY (parent_group_id) REFERENCES test3.item(id);


--
-- TOC entry 3337 (class 2606 OID 36260)
-- Name: image fkkn5p1goa9wbjdgl8065awce55; Type: FK CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.image
    ADD CONSTRAINT fkkn5p1goa9wbjdgl8065awce55 FOREIGN KEY (item_id) REFERENCES test3.item(id);


--
-- TOC entry 3335 (class 2606 OID 36250)
-- Name: color_item fkm5mgq9bwi1ymsh338874kmuc7; Type: FK CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.color_item
    ADD CONSTRAINT fkm5mgq9bwi1ymsh338874kmuc7 FOREIGN KEY (color_id) REFERENCES test3.color(id);


--
-- TOC entry 3338 (class 2606 OID 36265)
-- Name: imagerequest fkp41504v3t4auhdqgti5uoke3w; Type: FK CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.imagerequest
    ADD CONSTRAINT fkp41504v3t4auhdqgti5uoke3w FOREIGN KEY (request_id) REFERENCES test3.request(id);


--
-- TOC entry 3336 (class 2606 OID 36255)
-- Name: color_item fksos4g6fwmpknvhomhusqjjbvq; Type: FK CONSTRAINT; Schema: test3; Owner: atlas
--

ALTER TABLE ONLY test3.color_item
    ADD CONSTRAINT fksos4g6fwmpknvhomhusqjjbvq FOREIGN KEY (item_id) REFERENCES test3.item(id);


-- Completed on 2023-10-10 16:48:19 CEST
