...
-- Started on 2023-10-10 16:57:11 CEST
...
--
-- TOC entry 8 (class 2615 OID 36276)
-- Name: test4; Type: SCHEMA; Schema: -; Owner: atlas
--

CREATE SCHEMA test4;


ALTER SCHEMA test4 OWNER TO atlas;
...
--
-- TOC entry 239 (class 1259 OID 36279)
-- Name: color; Type: TABLE; Schema: test4; Owner: atlas
--

CREATE TABLE test4.color (
    id bigint NOT NULL,
    name character varying(255)
);


ALTER TABLE test4.color OWNER TO atlas;

--
-- TOC entry 238 (class 1259 OID 36278)
-- Name: color_id_seq; Type: SEQUENCE; Schema: test4; Owner: atlas
--

CREATE SEQUENCE test4.color_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE test4.color_id_seq OWNER TO atlas;

--
-- TOC entry 3531 (class 0 OID 0)
-- Dependencies: 238
-- Name: color_id_seq; Type: SEQUENCE OWNED BY; Schema: test4; Owner: atlas
--

ALTER SEQUENCE test4.color_id_seq OWNED BY test4.color.id;


--
-- TOC entry 240 (class 1259 OID 36285)
-- Name: color_item; Type: TABLE; Schema: test4; Owner: atlas
--

CREATE TABLE test4.color_item (
    color_id bigint NOT NULL,
    itemlist_id bigint NOT NULL
);


ALTER TABLE test4.color_item OWNER TO atlas;

--
-- TOC entry 241 (class 1259 OID 36290)
-- Name: image; Type: TABLE; Schema: test4; Owner: atlas
--

CREATE TABLE test4.image (
    id bigint NOT NULL,
    file character varying(255),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE test4.image OWNER TO atlas;

--
-- TOC entry 243 (class 1259 OID 36296)
-- Name: imagerequest; Type: TABLE; Schema: test4; Owner: atlas
--

CREATE TABLE test4.imagerequest (
    id bigint NOT NULL,
    file character varying(255),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE test4.imagerequest OWNER TO atlas;

--
-- TOC entry 242 (class 1259 OID 36295)
-- Name: imagerequest_id_seq; Type: SEQUENCE; Schema: test4; Owner: atlas
--

CREATE SEQUENCE test4.imagerequest_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE test4.imagerequest_id_seq OWNER TO atlas;

--
-- TOC entry 3532 (class 0 OID 0)
-- Dependencies: 242
-- Name: imagerequest_id_seq; Type: SEQUENCE OWNED BY; Schema: test4; Owner: atlas
--

ALTER SEQUENCE test4.imagerequest_id_seq OWNED BY test4.imagerequest.id;


--
-- TOC entry 244 (class 1259 OID 36302)
-- Name: item; Type: TABLE; Schema: test4; Owner: atlas
--

CREATE TABLE test4.item (
    id bigint NOT NULL,
    author character varying(250),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE test4.item OWNER TO atlas;

--
-- TOC entry 245 (class 1259 OID 36309)
-- Name: item_color; Type: TABLE; Schema: test4; Owner: atlas
--

CREATE TABLE test4.item_color (
    item_id bigint NOT NULL,
    colors_id bigint NOT NULL
);


ALTER TABLE test4.item_color OWNER TO atlas;

--
-- TOC entry 237 (class 1259 OID 36277)
-- Name: native; Type: SEQUENCE; Schema: test4; Owner: atlas
--

CREATE SEQUENCE test4.native
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE test4.native OWNER TO atlas;

--
-- TOC entry 246 (class 1259 OID 36314)
-- Name: request; Type: TABLE; Schema: test4; Owner: atlas
--

CREATE TABLE test4.request (
    id bigint NOT NULL,
    createdate timestamp without time zone,
    link bigint,
    local_visibility boolean NOT NULL,
...
ALTER TABLE test4.request OWNER TO atlas;
...
--
-- TOC entry 3291 (class 2604 OID 36282)
-- Name: color id; Type: DEFAULT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.color ALTER COLUMN id SET DEFAULT nextval('test4.color_id_seq'::regclass);


--
-- TOC entry 3292 (class 2604 OID 36299)
-- Name: imagerequest id; Type: DEFAULT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.imagerequest ALTER COLUMN id SET DEFAULT nextval('test4.imagerequest_id_seq'::regclass);
...
--
-- TOC entry 3511 (class 0 OID 36279)
-- Dependencies: 239
-- Data for Name: color; Type: TABLE DATA; Schema: test4; Owner: atlas
--

COPY test4.color (id, name) FROM stdin;
1	black
2	white
3	purple
4	green
...
--
-- TOC entry 3512 (class 0 OID 36285)
-- Dependencies: 240
-- Data for Name: color_item; Type: TABLE DATA; Schema: test4; Owner: atlas
--

COPY test4.color_item (color_id, itemlist_id) FROM stdin;
\.


--
-- TOC entry 3513 (class 0 OID 36290)
-- Dependencies: 241
-- Data for Name: image; Type: TABLE DATA; Schema: test4; Owner: atlas
--

COPY test4.image (id, file, createdate, modifydate, item_id) FROM stdin;
\.


--
-- TOC entry 3515 (class 0 OID 36296)
-- Dependencies: 243
-- Data for Name: imagerequest; Type: TABLE DATA; Schema: test4; Owner: atlas
--

COPY test4.imagerequest (id, file, createdate, modifydate, request_id) FROM stdin;
\.


--
-- TOC entry 3516 (class 0 OID 36302)
-- Dependencies: 244
-- Data for Name: item; Type: TABLE DATA; Schema: test4; Owner: atlas
--

COPY test4.item (id, author, createdate, modifydate, name, name2, text, typ, parent_group_id) FROM stdin;
1	\N	2023-10-10 16:48:30.342	2023-10-10 16:48:30.342	test4	\N	\N	0	\N
\.


--
-- TOC entry 3517 (class 0 OID 36309)
-- Dependencies: 245
-- Data for Name: item_color; Type: TABLE DATA; Schema: test4; Owner: atlas
--

COPY test4.item_color (item_id, colors_id) FROM stdin;
\.


--
-- TOC entry 3518 (class 0 OID 36314)
-- Dependencies: 246
-- Data for Name: request; Type: TABLE DATA; Schema: test4; Owner: atlas
--

COPY test4.request (id, createdate, link, local_visibility, modifydate, name, parent_request_mark, request_mark, request_message, request_status, request_typ) FROM stdin;
\.
...
SELECT pg_catalog.setval('config.database_id_seq', 71, true);
...
SELECT pg_catalog.setval('config.log_id_seq', 44, true);
...
-- Dependencies: 238
-- Name: color_id_seq; Type: SEQUENCE SET; Schema: test4; Owner: atlas
--

SELECT pg_catalog.setval('test4.color_id_seq', 12, true);


--
-- TOC entry 3542 (class 0 OID 0)
-- Dependencies: 242
-- Name: imagerequest_id_seq; Type: SEQUENCE SET; Schema: test4; Owner: atlas
--

SELECT pg_catalog.setval('test4.imagerequest_id_seq', 1, false);


--
-- TOC entry 3543 (class 0 OID 0)
-- Dependencies: 237
-- Name: native; Type: SEQUENCE SET; Schema: test4; Owner: atlas
--

SELECT pg_catalog.setval('test4.native', 1, true);
...
--
-- TOC entry 3320 (class 2606 OID 36289)
-- Name: color_item color_item_pkey; Type: CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.color_item
    ADD CONSTRAINT color_item_pkey PRIMARY KEY (color_id, itemlist_id);


--
-- TOC entry 3318 (class 2606 OID 36284)
-- Name: color color_pkey; Type: CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.color
    ADD CONSTRAINT color_pkey PRIMARY KEY (id);


--
-- TOC entry 3322 (class 2606 OID 36294)
-- Name: image image_pkey; Type: CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.image
    ADD CONSTRAINT image_pkey PRIMARY KEY (id);


--
-- TOC entry 3324 (class 2606 OID 36301)
-- Name: imagerequest imagerequest_pkey; Type: CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.imagerequest
    ADD CONSTRAINT imagerequest_pkey PRIMARY KEY (id);


--
-- TOC entry 3328 (class 2606 OID 36313)
-- Name: item_color item_color_pkey; Type: CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.item_color
    ADD CONSTRAINT item_color_pkey PRIMARY KEY (item_id, colors_id);


--
-- TOC entry 3326 (class 2606 OID 36308)
-- Name: item item_pkey; Type: CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.item
    ADD CONSTRAINT item_pkey PRIMARY KEY (id);


--
-- TOC entry 3330 (class 2606 OID 36320)
-- Name: request request_pkey; Type: CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.request
    ADD CONSTRAINT request_pkey PRIMARY KEY (id);
...
--
-- TOC entry 3340 (class 2606 OID 36321)
-- Name: color_item fk1fdfy94almvf8nypjhfcwoc48; Type: FK CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.color_item
    ADD CONSTRAINT fk1fdfy94almvf8nypjhfcwoc48 FOREIGN KEY (itemlist_id) REFERENCES test4.item(id);


--
-- TOC entry 3344 (class 2606 OID 36341)
-- Name: item fk59u490xlr5kh712mrlav698pf; Type: FK CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.item
    ADD CONSTRAINT fk59u490xlr5kh712mrlav698pf FOREIGN KEY (parent_group_id) REFERENCES test4.item(id);


--
-- TOC entry 3345 (class 2606 OID 36351)
-- Name: item_color fkc55phlubhh3dicouqch28q0o6; Type: FK CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.item_color
    ADD CONSTRAINT fkc55phlubhh3dicouqch28q0o6 FOREIGN KEY (item_id) REFERENCES test4.item(id);


--
-- TOC entry 3342 (class 2606 OID 36331)
-- Name: image fkkn5p1goa9wbjdgl8065awce55; Type: FK CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.image
    ADD CONSTRAINT fkkn5p1goa9wbjdgl8065awce55 FOREIGN KEY (item_id) REFERENCES test4.item(id);


--
-- TOC entry 3346 (class 2606 OID 36346)
-- Name: item_color fkle5785w1qjupjfqm1muwqi9lp; Type: FK CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.item_color
    ADD CONSTRAINT fkle5785w1qjupjfqm1muwqi9lp FOREIGN KEY (colors_id) REFERENCES test4.color(id);


--
-- TOC entry 3341 (class 2606 OID 36326)
-- Name: color_item fkm5mgq9bwi1ymsh338874kmuc7; Type: FK CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.color_item
    ADD CONSTRAINT fkm5mgq9bwi1ymsh338874kmuc7 FOREIGN KEY (color_id) REFERENCES test4.color(id);


--
-- TOC entry 3343 (class 2606 OID 36336)
-- Name: imagerequest fkp41504v3t4auhdqgti5uoke3w; Type: FK CONSTRAINT; Schema: test4; Owner: atlas
--

ALTER TABLE ONLY test4.imagerequest
    ADD CONSTRAINT fkp41504v3t4auhdqgti5uoke3w FOREIGN KEY (request_id) REFERENCES test4.request(id);


-- Completed on 2023-10-10 16:57:11 CEST
