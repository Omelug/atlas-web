...
-- Started on 2023-10-12 22:02:10 CEST
...
--
-- TOC entry 8 (class 2615 OID 36502)
-- Name: jhv; Type: SCHEMA; Schema: -; Owner: atlas
--

CREATE SCHEMA jhv;


ALTER SCHEMA jhv OWNER TO atlas;
...
--
-- TOC entry 239 (class 1259 OID 36505)
-- Name: color; Type: TABLE; Schema: jhv; Owner: atlas
--

CREATE TABLE jhv.color (
    id bigint NOT NULL,
    name character varying(255)
);


ALTER TABLE jhv.color OWNER TO atlas;

--
-- TOC entry 238 (class 1259 OID 36504)
-- Name: color_id_seq; Type: SEQUENCE; Schema: jhv; Owner: atlas
--

CREATE SEQUENCE jhv.color_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE jhv.color_id_seq OWNER TO atlas;

--
-- TOC entry 3520 (class 0 OID 0)
-- Dependencies: 238
-- Name: color_id_seq; Type: SEQUENCE OWNED BY; Schema: jhv; Owner: atlas
--

ALTER SEQUENCE jhv.color_id_seq OWNED BY jhv.color.id;


--
-- TOC entry 240 (class 1259 OID 36511)
-- Name: color_item; Type: TABLE; Schema: jhv; Owner: atlas
--

CREATE TABLE jhv.color_item (
    item_id bigint NOT NULL,
    color_id bigint NOT NULL
);


ALTER TABLE jhv.color_item OWNER TO atlas;

--
-- TOC entry 241 (class 1259 OID 36516)
-- Name: image; Type: TABLE; Schema: jhv; Owner: atlas
--

CREATE TABLE jhv.image (
    id bigint NOT NULL,
...
ALTER TABLE jhv.image OWNER TO atlas;

--
-- TOC entry 243 (class 1259 OID 36522)
-- Name: imagerequest; Type: TABLE; Schema: jhv; Owner: atlas
--

CREATE TABLE jhv.imagerequest (
    id bigint NOT NULL,
    file character varying(255),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE jhv.imagerequest OWNER TO atlas;

--
-- TOC entry 242 (class 1259 OID 36521)
-- Name: imagerequest_id_seq; Type: SEQUENCE; Schema: jhv; Owner: atlas
--

CREATE SEQUENCE jhv.imagerequest_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE jhv.imagerequest_id_seq OWNER TO atlas;

--
-- TOC entry 3521 (class 0 OID 0)
-- Dependencies: 242
-- Name: imagerequest_id_seq; Type: SEQUENCE OWNED BY; Schema: jhv; Owner: atlas
--

ALTER SEQUENCE jhv.imagerequest_id_seq OWNED BY jhv.imagerequest.id;


--
-- TOC entry 244 (class 1259 OID 36528)
-- Name: item; Type: TABLE; Schema: jhv; Owner: atlas
--

CREATE TABLE jhv.item (
    id bigint NOT NULL,
    author character varying(250),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE jhv.item OWNER TO atlas;

--
-- TOC entry 237 (class 1259 OID 36503)
-- Name: native; Type: SEQUENCE; Schema: jhv; Owner: atlas
--

CREATE SEQUENCE jhv.native
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE jhv.native OWNER TO atlas;

--
-- TOC entry 245 (class 1259 OID 36535)
-- Name: request; Type: TABLE; Schema: jhv; Owner: atlas
--

CREATE TABLE jhv.request (
    id bigint NOT NULL,
    createdate timestamp without time zone,
    link bigint,
...
ALTER TABLE jhv.request OWNER TO atlas;

--
-- TOC entry 230 (class 1259 OID 36440)
...
--
-- TOC entry 229 (class 1259 OID 36439)
...
--
-- TOC entry 231 (class 1259 OID 36446)
...
--
-- TOC entry 232 (class 1259 OID 36451)
...
--
-- TOC entry 234 (class 1259 OID 36457)
...
--
-- TOC entry 233 (class 1259 OID 36456)
...
--
-- TOC entry 235 (class 1259 OID 36463)
...
--
-- TOC entry 228 (class 1259 OID 36438)
...
--
-- TOC entry 236 (class 1259 OID 36470)
...
--
-- TOC entry 3280 (class 2604 OID 31119)
...
--
-- TOC entry 3281 (class 2604 OID 31133)
...
--
-- TOC entry 3282 (class 2604 OID 31142)
...
--
-- TOC entry 3283 (class 2604 OID 31149)
...
--
-- TOC entry 3284 (class 2604 OID 31156)
...
--
-- TOC entry 3287 (class 2604 OID 36508)
-- Name: color id; Type: DEFAULT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.color ALTER COLUMN id SET DEFAULT nextval('jhv.color_id_seq'::regclass);


--
-- TOC entry 3288 (class 2604 OID 36525)
-- Name: imagerequest id; Type: DEFAULT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.imagerequest ALTER COLUMN id SET DEFAULT nextval('jhv.imagerequest_id_seq'::regclass);


--
-- TOC entry 3285 (class 2604 OID 36443)
...
--
-- TOC entry 3286 (class 2604 OID 36460)
...
--
-- TOC entry 3482 (class 0 OID 31116)
-- Dependencies: 218
...
--
-- TOC entry 3483 (class 0 OID 31122)
-- Dependencies: 219
...
--
-- TOC entry 3485 (class 0 OID 31130)
-- Dependencies: 221
...
52	Folder for  jhv created	2023-10-11 11:12:54.466	databaseCreation	0
53	User user have not access to jhv	2023-10-11 11:15:09.31	admin	1
\.


--
-- TOC entry 3487 (class 0 OID 31139)
-- Dependencies: 223
...
--
-- TOC entry 3489 (class 0 OID 31146)
-- Dependencies: 225
...
--
-- TOC entry 3491 (class 0 OID 31153)
-- Dependencies: 227
...
10	t	jhv	2023-09-25 08:57:41.428	2023-10-12 22:01:16.023	\N	admin	$2a$10$X3iBZZQgGfvxx4olu6YwCebHTBiV9iqcEAN3Anb4VbljJZV3oGhPa	\N	\N	2023-10-12 22:01:16.05
\.


--
-- TOC entry 3503 (class 0 OID 36505)
-- Dependencies: 239
-- Data for Name: color; Type: TABLE DATA; Schema: jhv; Owner: atlas
--

COPY jhv.color (id, name) FROM stdin;
1	black
2	white
3	purple
4	green
...
--
-- TOC entry 3504 (class 0 OID 36511)
-- Dependencies: 240
-- Data for Name: color_item; Type: TABLE DATA; Schema: jhv; Owner: atlas
--

COPY jhv.color_item (item_id, color_id) FROM stdin;
3	9
3	3
7	3
7	7
...
--
-- TOC entry 3505 (class 0 OID 36516)
-- Dependencies: 241
-- Data for Name: image; Type: TABLE DATA; Schema: jhv; Owner: atlas
--

COPY jhv.image (id, file, createdate, modifydate, item_id) FROM stdin;
6	1 2CnUXGru43gDETMBxhU7YQ.webp	2023-10-11 19:23:20.141	2023-10-11 19:23:20.141	4
\.


--
-- TOC entry 3507 (class 0 OID 36522)
-- Dependencies: 243
-- Data for Name: imagerequest; Type: TABLE DATA; Schema: jhv; Owner: atlas
--

COPY jhv.imagerequest (id, file, createdate, modifydate, request_id) FROM stdin;
\.


--
-- TOC entry 3508 (class 0 OID 36528)
-- Dependencies: 244
-- Data for Name: item; Type: TABLE DATA; Schema: jhv; Owner: atlas
--

COPY jhv.item (id, author, createdate, modifydate, name, name2, text, typ, parent_group_id) FROM stdin;
3	\N	2023-10-11 19:04:47.54	2023-10-11 19:04:47.54	awdawdawawdaw	\N		1	2
7	\N	2023-10-11 19:39:38.348	2023-10-11 19:41:40.136	awdawdawdaw	\N		1	3
4	\N	2023-10-11 19:13:53.538	2023-10-11 19:53:24.082	wdawdawda	awdawdaw	<p>,jgfjh</p>	1	2
1	\N	2023-10-11 11:15:46.609	2023-10-11 20:06:26.981	jhv	\N		0	\N
18	\N	2023-10-11 22:45:29.974	2023-10-11 22:45:29.974	awdawdaw	\N		1	2
2	\N	2023-10-11 18:54:50.603	2023-10-12 08:31:49.795	awdawdawawdawdd	\N		1	1
19	\N	2023-10-12 08:34:59.24	2023-10-12 08:34:59.24	   	\N		1	1
20	\N	2023-10-12 08:38:42.359	2023-10-12 08:38:42.36	weefsef	\N		1	1
21	\N	2023-10-12 08:48:18.376	2023-10-12 08:48:18.376	awdawdaw	\N		1	1
22	\N	2023-10-12 08:51:37.516	2023-10-12 08:51:37.516	awdawdaw	\N		1	1
23	bfxxfb	2023-10-12 09:17:04.221	2023-10-12 09:17:04.221	bfxfxbxb	xbffbxfxb		2	1
\.


--
-- TOC entry 3509 (class 0 OID 36535)
-- Dependencies: 245
-- Data for Name: request; Type: TABLE DATA; Schema: jhv; Owner: atlas
--

COPY jhv.request (id, createdate, link, local_visibility, modifydate, name, parent_request_mark, request_mark, request_message, request_status, request_typ) FROM stdin;
\.


--
-- TOC entry 3494 (class 0 OID 36440)
-- Dependencies: 230
...
--
-- TOC entry 3495 (class 0 OID 36446)
-- Dependencies: 231
...
--
-- TOC entry 3496 (class 0 OID 36451)
-- Dependencies: 232
...
--
-- TOC entry 3498 (class 0 OID 36457)
-- Dependencies: 234
...
--
-- TOC entry 3499 (class 0 OID 36463)
-- Dependencies: 235
...
--
-- TOC entry 3500 (class 0 OID 36470)
-- Dependencies: 236
...
SELECT pg_catalog.setval('config.database_id_seq', 75, true);
...
SELECT pg_catalog.setval('config.log_id_seq', 53, true);
...
SELECT pg_catalog.setval('config.udrlink_id_seq', 3, true);
...
-- Dependencies: 238
-- Name: color_id_seq; Type: SEQUENCE SET; Schema: jhv; Owner: atlas
--

SELECT pg_catalog.setval('jhv.color_id_seq', 44, true);


--
-- TOC entry 3530 (class 0 OID 0)
-- Dependencies: 242
-- Name: imagerequest_id_seq; Type: SEQUENCE SET; Schema: jhv; Owner: atlas
--

SELECT pg_catalog.setval('jhv.imagerequest_id_seq', 1, false);


--
-- TOC entry 3531 (class 0 OID 0)
-- Dependencies: 237
-- Name: native; Type: SEQUENCE SET; Schema: jhv; Owner: atlas
--

SELECT pg_catalog.setval('jhv.native', 23, true);
...
--
-- TOC entry 3290 (class 2606 OID 31121)
...
--
-- TOC entry 3292 (class 2606 OID 31128)
...
--
-- TOC entry 3294 (class 2606 OID 31137)
...
--
-- TOC entry 3296 (class 2606 OID 31144)
...
--
-- TOC entry 3298 (class 2606 OID 31151)
...
--
-- TOC entry 3300 (class 2606 OID 31160)
...
--
-- TOC entry 3316 (class 2606 OID 36515)
-- Name: color_item color_item_pkey; Type: CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.color_item
    ADD CONSTRAINT color_item_pkey PRIMARY KEY (item_id, color_id);


--
-- TOC entry 3314 (class 2606 OID 36510)
-- Name: color color_pkey; Type: CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.color
    ADD CONSTRAINT color_pkey PRIMARY KEY (id);


--
-- TOC entry 3318 (class 2606 OID 36520)
-- Name: image image_pkey; Type: CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.image
    ADD CONSTRAINT image_pkey PRIMARY KEY (id);


--
-- TOC entry 3320 (class 2606 OID 36527)
-- Name: imagerequest imagerequest_pkey; Type: CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.imagerequest
    ADD CONSTRAINT imagerequest_pkey PRIMARY KEY (id);


--
-- TOC entry 3322 (class 2606 OID 36534)
-- Name: item item_pkey; Type: CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.item
    ADD CONSTRAINT item_pkey PRIMARY KEY (id);


--
-- TOC entry 3324 (class 2606 OID 36541)
-- Name: request request_pkey; Type: CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.request
    ADD CONSTRAINT request_pkey PRIMARY KEY (id);


--
-- TOC entry 3304 (class 2606 OID 36450)
...
--
-- TOC entry 3302 (class 2606 OID 36445)
...
--
-- TOC entry 3306 (class 2606 OID 36455)
...
--
-- TOC entry 3308 (class 2606 OID 36462)
...
--
-- TOC entry 3310 (class 2606 OID 36469)
...
--
-- TOC entry 3312 (class 2606 OID 36476)
...
--
-- TOC entry 3326 (class 2606 OID 31219)
...
--
-- TOC entry 3327 (class 2606 OID 31214)
...
--
-- TOC entry 3325 (class 2606 OID 31204)
...
--
-- TOC entry 3328 (class 2606 OID 31209)
...
--
-- TOC entry 3338 (class 2606 OID 36562)
-- Name: item fk59u490xlr5kh712mrlav698pf; Type: FK CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.item
    ADD CONSTRAINT fk59u490xlr5kh712mrlav698pf FOREIGN KEY (parent_group_id) REFERENCES jhv.item(id);


--
-- TOC entry 3334 (class 2606 OID 36547)
-- Name: color_item fk9eoy3uf2r7guvjw1f38h2c4ei; Type: FK CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.color_item
    ADD CONSTRAINT fk9eoy3uf2r7guvjw1f38h2c4ei FOREIGN KEY (item_id) REFERENCES jhv.item(id);


--
-- TOC entry 3335 (class 2606 OID 36542)
-- Name: color_item fkgp1pmjtik5kw34px2gx14v2o3; Type: FK CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.color_item
    ADD CONSTRAINT fkgp1pmjtik5kw34px2gx14v2o3 FOREIGN KEY (color_id) REFERENCES jhv.color(id);


--
-- TOC entry 3337 (class 2606 OID 36557)
-- Name: imagerequest fkjel1coa9xxf59wax6dqxp6ffn; Type: FK CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.imagerequest
    ADD CONSTRAINT fkjel1coa9xxf59wax6dqxp6ffn FOREIGN KEY (request_id) REFERENCES jhv.request(id);


--
-- TOC entry 3336 (class 2606 OID 36552)
-- Name: image fkkn5p1goa9wbjdgl8065awce55; Type: FK CONSTRAINT; Schema: jhv; Owner: atlas
--

ALTER TABLE ONLY jhv.image
    ADD CONSTRAINT fkkn5p1goa9wbjdgl8065awce55 FOREIGN KEY (item_id) REFERENCES jhv.item(id);


--
-- TOC entry 3333 (class 2606 OID 36497)
...
--
-- TOC entry 3329 (class 2606 OID 36482)
...
--
-- TOC entry 3330 (class 2606 OID 36477)
...
--
-- TOC entry 3331 (class 2606 OID 36487)
...
--
-- TOC entry 3332 (class 2606 OID 36492)
...
-- Completed on 2023-10-12 22:02:10 CEST
