...
-- Started on 2023-10-10 16:22:23 CEST
...
--
-- TOC entry 8 (class 2615 OID 36125)
-- Name: test2; Type: SCHEMA; Schema: -; Owner: atlas
--

CREATE SCHEMA test2;


ALTER SCHEMA test2 OWNER TO atlas;
...
--
-- TOC entry 239 (class 1259 OID 36128)
-- Name: color; Type: TABLE; Schema: test2; Owner: atlas
--

CREATE TABLE test2.color (
    id bigint NOT NULL,
    name character varying(255)
);


ALTER TABLE test2.color OWNER TO atlas;

--
-- TOC entry 238 (class 1259 OID 36127)
-- Name: color_id_seq; Type: SEQUENCE; Schema: test2; Owner: atlas
--

CREATE SEQUENCE test2.color_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE test2.color_id_seq OWNER TO atlas;

--
-- TOC entry 3531 (class 0 OID 0)
-- Dependencies: 238
-- Name: color_id_seq; Type: SEQUENCE OWNED BY; Schema: test2; Owner: atlas
--

ALTER SEQUENCE test2.color_id_seq OWNED BY test2.color.id;


--
-- TOC entry 240 (class 1259 OID 36134)
-- Name: color_item; Type: TABLE; Schema: test2; Owner: atlas
--

CREATE TABLE test2.color_item (
    color_id bigint NOT NULL,
    itemlist_id bigint NOT NULL
);


ALTER TABLE test2.color_item OWNER TO atlas;

--
-- TOC entry 241 (class 1259 OID 36139)
-- Name: image; Type: TABLE; Schema: test2; Owner: atlas
--

CREATE TABLE test2.image (
    id bigint NOT NULL,
    file character varying(255),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE test2.image OWNER TO atlas;

--
-- TOC entry 243 (class 1259 OID 36145)
-- Name: imagerequest; Type: TABLE; Schema: test2; Owner: atlas
--

CREATE TABLE test2.imagerequest (
    id bigint NOT NULL,
    file character varying(255),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE test2.imagerequest OWNER TO atlas;

--
-- TOC entry 242 (class 1259 OID 36144)
-- Name: imagerequest_id_seq; Type: SEQUENCE; Schema: test2; Owner: atlas
--

CREATE SEQUENCE test2.imagerequest_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE test2.imagerequest_id_seq OWNER TO atlas;

--
-- TOC entry 3532 (class 0 OID 0)
-- Dependencies: 242
-- Name: imagerequest_id_seq; Type: SEQUENCE OWNED BY; Schema: test2; Owner: atlas
--

ALTER SEQUENCE test2.imagerequest_id_seq OWNED BY test2.imagerequest.id;


--
-- TOC entry 244 (class 1259 OID 36151)
-- Name: item; Type: TABLE; Schema: test2; Owner: atlas
--

CREATE TABLE test2.item (
    id bigint NOT NULL,
    author character varying(250),
    createdate timestamp without time zone,
    modifydate timestamp without time zone,
...
ALTER TABLE test2.item OWNER TO atlas;

--
-- TOC entry 245 (class 1259 OID 36158)
-- Name: item_color_list; Type: TABLE; Schema: test2; Owner: atlas
--

CREATE TABLE test2.item_color_list (
    item_id bigint NOT NULL,
    color_id bigint NOT NULL
);


ALTER TABLE test2.item_color_list OWNER TO atlas;

--
-- TOC entry 237 (class 1259 OID 36126)
-- Name: native; Type: SEQUENCE; Schema: test2; Owner: atlas
--

CREATE SEQUENCE test2.native
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE test2.native OWNER TO atlas;

--
-- TOC entry 246 (class 1259 OID 36163)
-- Name: request; Type: TABLE; Schema: test2; Owner: atlas
--

CREATE TABLE test2.request (
    id bigint NOT NULL,
    createdate timestamp without time zone,
    link bigint,
    local_visibility boolean NOT NULL,
...
ALTER TABLE test2.request OWNER TO atlas;
...
--
-- TOC entry 3291 (class 2604 OID 36131)
-- Name: color id; Type: DEFAULT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.color ALTER COLUMN id SET DEFAULT nextval('test2.color_id_seq'::regclass);


--
-- TOC entry 3292 (class 2604 OID 36148)
-- Name: imagerequest id; Type: DEFAULT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.imagerequest ALTER COLUMN id SET DEFAULT nextval('test2.imagerequest_id_seq'::regclass);
...
10	t	test2	2023-09-25 08:57:41.428	2023-10-10 15:06:52.255	\N	admin	$2a$10$X3iBZZQgGfvxx4olu6YwCebHTBiV9iqcEAN3Anb4VbljJZV3oGhPa	\N	\N	2023-10-10 16:16:14.974
...
--
-- TOC entry 3511 (class 0 OID 36128)
-- Dependencies: 239
-- Data for Name: color; Type: TABLE DATA; Schema: test2; Owner: atlas
--

COPY test2.color (id, name) FROM stdin;
1	black
2	white
3	purple
4	green
...
--
-- TOC entry 3512 (class 0 OID 36134)
-- Dependencies: 240
-- Data for Name: color_item; Type: TABLE DATA; Schema: test2; Owner: atlas
--

COPY test2.color_item (color_id, itemlist_id) FROM stdin;
\.


--
-- TOC entry 3513 (class 0 OID 36139)
-- Dependencies: 241
-- Data for Name: image; Type: TABLE DATA; Schema: test2; Owner: atlas
--

COPY test2.image (id, file, createdate, modifydate, item_id) FROM stdin;
\.


--
-- TOC entry 3515 (class 0 OID 36145)
-- Dependencies: 243
-- Data for Name: imagerequest; Type: TABLE DATA; Schema: test2; Owner: atlas
--

COPY test2.imagerequest (id, file, createdate, modifydate, request_id) FROM stdin;
\.


--
-- TOC entry 3516 (class 0 OID 36151)
-- Dependencies: 244
-- Data for Name: item; Type: TABLE DATA; Schema: test2; Owner: atlas
--

COPY test2.item (id, author, createdate, modifydate, name, name2, text, typ, parent_group_id) FROM stdin;
1	\N	2023-10-10 16:16:18.028	2023-10-10 16:16:18.028	test2	\N	\N	0	\N
\.


--
-- TOC entry 3517 (class 0 OID 36158)
-- Dependencies: 245
-- Data for Name: item_color_list; Type: TABLE DATA; Schema: test2; Owner: atlas
--

COPY test2.item_color_list (item_id, color_id) FROM stdin;
\.


--
-- TOC entry 3518 (class 0 OID 36163)
-- Dependencies: 246
-- Data for Name: request; Type: TABLE DATA; Schema: test2; Owner: atlas
--

COPY test2.request (id, createdate, link, local_visibility, modifydate, name, parent_request_mark, request_mark, request_message, request_status, request_typ) FROM stdin;
\.
...
SELECT pg_catalog.setval('config.database_id_seq', 69, true);
...
SELECT pg_catalog.setval('config.log_id_seq', 42, true);
...
-- Dependencies: 238
-- Name: color_id_seq; Type: SEQUENCE SET; Schema: test2; Owner: atlas
--

SELECT pg_catalog.setval('test2.color_id_seq', 12, true);


--
-- TOC entry 3542 (class 0 OID 0)
-- Dependencies: 242
-- Name: imagerequest_id_seq; Type: SEQUENCE SET; Schema: test2; Owner: atlas
--

SELECT pg_catalog.setval('test2.imagerequest_id_seq', 1, false);


--
-- TOC entry 3543 (class 0 OID 0)
-- Dependencies: 237
-- Name: native; Type: SEQUENCE SET; Schema: test2; Owner: atlas
--

SELECT pg_catalog.setval('test2.native', 1, true);
...
--
-- TOC entry 3320 (class 2606 OID 36138)
-- Name: color_item color_item_pkey; Type: CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.color_item
    ADD CONSTRAINT color_item_pkey PRIMARY KEY (color_id, itemlist_id);


--
-- TOC entry 3318 (class 2606 OID 36133)
-- Name: color color_pkey; Type: CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.color
    ADD CONSTRAINT color_pkey PRIMARY KEY (id);


--
-- TOC entry 3322 (class 2606 OID 36143)
-- Name: image image_pkey; Type: CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.image
    ADD CONSTRAINT image_pkey PRIMARY KEY (id);


--
-- TOC entry 3324 (class 2606 OID 36150)
-- Name: imagerequest imagerequest_pkey; Type: CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.imagerequest
    ADD CONSTRAINT imagerequest_pkey PRIMARY KEY (id);


--
-- TOC entry 3328 (class 2606 OID 36162)
-- Name: item_color_list item_color_list_pkey; Type: CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.item_color_list
    ADD CONSTRAINT item_color_list_pkey PRIMARY KEY (item_id, color_id);


--
-- TOC entry 3326 (class 2606 OID 36157)
-- Name: item item_pkey; Type: CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.item
    ADD CONSTRAINT item_pkey PRIMARY KEY (id);


--
-- TOC entry 3330 (class 2606 OID 36169)
-- Name: request request_pkey; Type: CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.request
    ADD CONSTRAINT request_pkey PRIMARY KEY (id);
...
--
-- TOC entry 3340 (class 2606 OID 36170)
-- Name: color_item fk1fdfy94almvf8nypjhfcwoc48; Type: FK CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.color_item
    ADD CONSTRAINT fk1fdfy94almvf8nypjhfcwoc48 FOREIGN KEY (itemlist_id) REFERENCES test2.item(id);


--
-- TOC entry 3345 (class 2606 OID 36195)
-- Name: item_color_list fk2y7h129qhqjinyav7qhfb2ind; Type: FK CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.item_color_list
    ADD CONSTRAINT fk2y7h129qhqjinyav7qhfb2ind FOREIGN KEY (color_id) REFERENCES test2.color(id);


--
-- TOC entry 3344 (class 2606 OID 36190)
-- Name: item fk59u490xlr5kh712mrlav698pf; Type: FK CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.item
    ADD CONSTRAINT fk59u490xlr5kh712mrlav698pf FOREIGN KEY (parent_group_id) REFERENCES test2.item(id);


--
-- TOC entry 3346 (class 2606 OID 36200)
-- Name: item_color_list fkkfv45obbke5k74mql04eyxjr4; Type: FK CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.item_color_list
    ADD CONSTRAINT fkkfv45obbke5k74mql04eyxjr4 FOREIGN KEY (item_id) REFERENCES test2.item(id);


--
-- TOC entry 3342 (class 2606 OID 36180)
-- Name: image fkkn5p1goa9wbjdgl8065awce55; Type: FK CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.image
    ADD CONSTRAINT fkkn5p1goa9wbjdgl8065awce55 FOREIGN KEY (item_id) REFERENCES test2.item(id);


--
-- TOC entry 3341 (class 2606 OID 36175)
-- Name: color_item fkm5mgq9bwi1ymsh338874kmuc7; Type: FK CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.color_item
    ADD CONSTRAINT fkm5mgq9bwi1ymsh338874kmuc7 FOREIGN KEY (color_id) REFERENCES test2.color(id);


--
-- TOC entry 3343 (class 2606 OID 36185)
-- Name: imagerequest fkp41504v3t4auhdqgti5uoke3w; Type: FK CONSTRAINT; Schema: test2; Owner: atlas
--

ALTER TABLE ONLY test2.imagerequest
    ADD CONSTRAINT fkp41504v3t4auhdqgti5uoke3w FOREIGN KEY (request_id) REFERENCES test2.request(id);


-- Completed on 2023-10-10 16:22:23 CEST
